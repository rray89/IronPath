...
enum class TrainingGoal { Strength, Hypertrophy, Endurance, Rehab }
...
private data class ExerciseTemplate(val name: String, val sets: Int, val reps: Int, val weightKg: Double)
...
private val hypertrophyTemplates = listOf(
    WorkoutTemplate("Chest/Tris", listOf(
    ...
    WorkoutTemplate("Back/Bis", listOf(
    ...
    WorkoutTemplate("Shoulders/Arms", listOf(
...
private val rehabTemplates = listOf(
    WorkoutTemplate("Upper Mobility", listOf(
    ...
    WorkoutTemplate("Lower Mobility", listOf(
