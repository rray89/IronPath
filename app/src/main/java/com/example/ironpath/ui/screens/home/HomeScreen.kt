        ...
        Box(
            ...
            Row {
                ...
                Column {
                    ...
                    Text(
                        text = "Use the Plan tab to choose your workout days, generate a 1-week plan, and review it before saving.",
        ...
        Box(
            ...
            Column {
                ...
                if (state.nextWorkout != null) {
                    ...
                    Text(
                        text = "$prefix: ${dayOfWeekAbbrev(state.nextWorkout.dayOfWeek)}  •  ${state.nextWorkout.title}",
                        style = MaterialTheme.typography.bodyLarge,
                        color = MaterialTheme.colorScheme.onSurface,
                    )
                }
