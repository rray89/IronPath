...
class SessionRepository(
    ...
    /**
     * Clears any existing active session, then starts a new one with its
     * exercises in a single transaction (handled by DAO @Transaction).
     */
    ...
    /**
     * Completes a session: deletes the active session and inserts a workout log.
     * Uses withTransaction because this spans two DAOs.
     */
